...
nypd_man = pd.read_csv('2017/nypd2017_man.csv') #CHANGE YEAR

permits_bx = pd.read_csv('boro_data/permits_bx.csv')
nypd_bx = pd.read_csv('2017/nypd2017_bx.csv') #CHANGE YEAR

permits_si = pd.read_csv('boro_data/permits_si.csv')
nypd_si = pd.read_csv('2017/nypd2017_si.csv') #CHANGE YEAR

permits_qn = pd.read_csv('boro_data/permits_qn.csv')
nypd_qn = pd.read_csv('2017/nypd2017_qn.csv') #CHANGE YEAR

permits_bk = pd.read_csv('boro_data/permits_bk.csv')
nypd_bk = pd.read_csv('2017/nypd2017_bk.csv') #CHANGE YEAR
