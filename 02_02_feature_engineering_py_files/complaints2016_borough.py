...
nypd_man = pd.read_csv('2016/nypd2016_man.csv') #CHANGE YEAR
nypd_bx = pd.read_csv('2016/nypd2016_bx.csv') #CHANGE YEAR
nypd_si = pd.read_csv('2016/nypd2016_si.csv') #CHANGE YEAR
nypd_qn = pd.read_csv('2016/nypd2016_qn.csv') #CHANGE YEAR
nypd_bk = pd.read_csv('2016/nypd2016_bk.csv') #CHANGE YEAR
