...
nypd_man = pd.read_csv('data_nypd_by_year/2018/nypd2018_man.csv') #CHANGE YEAR
nypd_bx = pd.read_csv('data_nypd_by_year/2018/nypd2018_bx.csv') #CHANGE YEAR
nypd_si = pd.read_csv('data_nypd_by_year/2018/nypd2018_si.csv') #CHANGE YEAR
nypd_qn = pd.read_csv('data_nypd_by_year/2018/nypd2018_qn.csv') #CHANGE YEAR
nypd_bk = pd.read_csv('data_nypd_by_year/2018/nypd2018_bk.csv') #CHANGE YEAR
