...
nypd_man = pd.read_csv('data_nypd_by_year/2014/nypd2014_man.csv') #CHANGE YEAR

permits_bx = pd.read_csv('data_permits_by_boro/permits_bx.csv')
nypd_bx = pd.read_csv('data_nypd_by_year/2014/nypd2014_bx.csv') #CHANGE YEAR

permits_si = pd.read_csv('data_permits_by_boro/permits_si.csv')
nypd_si = pd.read_csv('data_nypd_by_year/2014/nypd2014_si.csv') #CHANGE YEAR

permits_qn = pd.read_csv('data_permits_by_boro/permits_qn.csv')
nypd_qn = pd.read_csv('data_nypd_by_year/2014/nypd2014_qn.csv') #CHANGE YEAR

permits_bk = pd.read_csv('data_permits_by_boro/permits_bk.csv')
nypd_bk = pd.read_csv('data_nypd_by_year/2014/nypd2014_bk.csv') #CHANGE YEAR
...
permits_man.to_csv('permits_complaints2014_man.csv', index = False) #CHANGE BOROUGH, CHANGE YEAR, CHANGE BOROUGH
...
permits_bx.to_csv('permits_complaints2014_bx.csv', index = False) #CHANGE YEAR
...
permits_si.to_csv('permits_complaints2014_si.csv', index = False) #CHANGE YEAR
...
permits_qn.to_csv('permits_complaints2014_qn.csv', index = False) #CHANGE YEAR
...
permits_bk.to_csv('permits_complaints2014_bk.csv', index = False) #CHANGE YEAR
